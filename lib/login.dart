...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String urlLogin = "https://saujanaeclipse.com/CtHijab/php/login.php";
  ...
  Widget uppHalf(BuildContext context) {
    return Container(
  ...
  Widget lowHalf(BuildContext context) {
    return Container(
      height: screenHeight / 2,
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              Text("Forgot your password ", style: TextStyle(fontSize: 20.0)),
              GestureDetector(
